...
from train import CustomSegmentation, net_names
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='../../dataset/seg/test2',
                        help='input data dir')
    ...
    model = CustomSegmentation.try_load(opt.net, opt.ckpt, opt.device, img_size=opt.img_size)
    model.eval()
    model.to(device)
